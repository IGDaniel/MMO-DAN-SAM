...
switch(command){
    ...
    case "LOGIN":
        ...
        if(status == "TRUE"){
            ...
            health = buffer_read(argument0, buffer_u16);
            attack = buffer_read(argument0, buffer_u16);
            defense = buffer_read(argument0, buffer_u16);
            gold = buffer_read(argument0, buffer_u16);
            crystals = buffer_read(argument0, buffer_u16);
